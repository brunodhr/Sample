...
return [
    ...
    'post' => [
        ...
        'title_sub'        => 'O título da sua notícia',
        'update'           => 'Alterar Notícia',
    ],

    'pages' => [
        'category'         => 'Categoria da Página',
        ...
        'meta_description' => 'Meta de Descrição',
        'meta_keywords'    => 'Meta de palavras-chave',
        'new'              => 'Criar nova página',
        'seo_content'      => 'Conteúdo do SEO',
        'seo_title'        => 'Título SEO',
        'slug'             => 'URL slug',
        'status'           => 'Status da Página',
        'status_draft'     => 'Rascunho',
        'status_pending'   => 'Pendente',
        'status_published' => 'Publicado',
        'title'            => 'Título da página',
        'title_sub'        => 'O título da sua página',
        'update'           => 'Alterar Página',
    ],
